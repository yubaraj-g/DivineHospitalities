...
function HeroSection2() {
  return (
    <div className="hero2 bg-white w-screen lg:w-screen flex flex-col lg:flex-row px-12" id="heroSection2">
      <div className="leftImg">
        {/* <img load="lazy" src={HeroImage2} alt="" width={"400px"} /> */}
        <img load="lazy" src={HeroImage2} alt="" width="" />
      </div>

      <div className="rightTexts">
        <h1 className="heroHeading text-xl">
